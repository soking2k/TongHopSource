          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <hr>
                <form action="${pageContext.request.contextPath}/view/admin/edituser" method="post">
                  ...
                  <div class="form-group">                  
					...
					<a href="${pageContext.request.contextPath}/view/admin/listuser" target="_self"><img class="pointer" style="cursor: pointer;" src="./img/huy.png">      
