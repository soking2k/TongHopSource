...
public class SanPham {
	...
	public SanPham() {}
	public SanPham(String id, String loaisp_id, String name, String price, String status, String description, String content,
	...
	public void seloaisp_id(String product_cate) {
		this.loaisp_id = product_cate;
	}
	...
	public String toString() {
		return "SanPham [id=" + id + ", loaisp_id=" + loaisp_id + ", name=" + name + ", price=" + price + ", status="
