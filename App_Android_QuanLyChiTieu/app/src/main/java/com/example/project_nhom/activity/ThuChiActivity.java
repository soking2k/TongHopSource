...
import com.example.project_nhom.Adapter.ThuChiAdapter;
...
public class ThuChiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InitUI();
        ThuChiAdapter = new ThuChiAdapter(new ThuChiAdapter.IClickItemViTien() {
            @Override
            public void ThemThuNhap(ViTien vitien) {
                clickthemthunhap(vitien);
            }


            @Override
            public void ThemChiTieu(ViTien vitien) {
                clickthemchitieu(vitien);
            }
        });

        mListViTien = new ArrayList<>();
        ThuChiAdapter.setData(mListViTien);

        LinearLayoutManager LinearLayoutManager = new LinearLayoutManager(this);
        rcvViTien.setLayoutManager(LinearLayoutManager);
        rcvViTien.setAdapter(ThuChiAdapter);
...
/*        tvDeleteAll.setOnClickListener(new View.OnClickListener() {
    ...
    private void clickthemthunhap(final ViTien viTien)
    {
        Intent intent = new Intent(ThuChiActivity.this,ThemThuNhapVi.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("object_vitien",viTien);
        intent.putExtras(bundle);
        startActivityForResult(intent,MY_REQUEST_CODE);
    }
    private void clickthemchitieu(final ViTien viTien)
    {
        Intent intent = new Intent(ThuChiActivity.this,ThemThuChiVi.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("object_vitien",viTien);
        intent.putExtras(bundle);
        startActivityForResult(intent,MY_REQUEST_CODE);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        AppDatabase.getInstance(ThuChiActivity.this).ViTienDAO().deleteAllViTien();
                        Toast.makeText(ThuChiActivity.this,"Xoa Toan Bo Vi Tien Thanh Cong",Toast.LENGTH_SHORT).show();
                        loadData();
                    }
                })
