          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <hr>
                <form method="post" action="${pageContext.request.contextPath}/view/admin/editorder">
                    ...
                    <div class="form-group">
	                  ...
	                  <div>
		               ...
		               <div class="form-footer">
							...
							<a href="${pageContext.request.contextPath}/view/admin/listorder" target="_self"><img class="pointer" style="cursor: pointer;" src="./img/huy.png">      
