                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="color: #298cc9;font-size: 22px;font-weight: bold;text-align: center;">Đăng nhập</h3>
                        </div>
                        <div class="panel-body">
                            <form action="${pageContext.request.contextPath}/view/admin/login"  method="post">
								 ...
								 <button type="submit" class="btn btn-primary btn-submit btn-block">Đăng nhập</button>
								 </form>
                        </div>
                    </div>
                </div>
