...
public class ThuChiAdapter extends RecyclerView.Adapter<ThuChiAdapter.ViTienHolder> {
 ...
 //   private AdapterView.OnItemClickListener listener;
    ...
    {
        void ThemThuNhap(ViTien vitien);
        void ThemChiTieu(ViTien vitien);
    }
    public ThuChiAdapter(Context context) {
        this.context = context;
    }
    public ThuChiAdapter(IClickItemViTien iClickItemViTien) {
    ...
    public void onBindViewHolder(@NonNull ViTienHolder holder, int position)
    {
        ...
        holder.btnUpdate1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                iClickItemViTien.ThemThuNhap(viTien);
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                iClickItemViTien.ThemChiTieu(viTien);
            }
        });
    }
